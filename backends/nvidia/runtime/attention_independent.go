...
func IndependentBranchAttentionBuffer(out, q, trunkK, trunkV, suffixK, suffixV, active *Buffer, batch, branchSlots, trunkLen, suffixStride, seqStart, seqLen, nHeads, nKVHeads, headDim int, scale float32) error {
	...
	if !okQ || !okKV || !okQN || !okTrunk || !okRows || !okSuffix || batch <= 0 || branchSlots < batch || trunkLen <= 0 || suffixStride < 0 || seqStart < 0 || seqLen <= 0 || seqLen > MaxDecisionAttentionTokens || trunkLen > MaxDecisionAttentionTokens || suffixStride > MaxDecisionAttentionTokens || seqStart > trunkLen+suffixStride-seqLen || nHeads > 256 || headDim > 2048 || nHeads <= 0 || nKVHeads <= 0 || headDim <= 0 || nHeads%nKVHeads != 0 || out == nil || q == nil || trunkK == nil || trunkV == nil || active == nil || out.Ptr == 0 || q.Ptr == 0 || trunkK.Ptr == 0 || trunkV.Ptr == 0 || active.Ptr == 0 || out.Size < qN*4 || q.Size < qN*4 || trunkK.Size < trunkN*4 || trunkV.Size < trunkN*4 || active.Size < batch*4 || suffixStride > 0 && (suffixK == nil || suffixV == nil || suffixK.Ptr == 0 || suffixV.Ptr == 0 || suffixK.Size < suffixN*4 || suffixV.Size < suffixN*4) || attnIndependentFn == 0 || !fitsUint32(batch) || !fitsUint32(trunkLen) || !fitsUint32(suffixStride) || !fitsUint32(seqStart) || !fitsUint32(seqLen) || !fitsUint32(nHeads) || !fitsUint32(nKVHeads) || !fitsUint32(headDim) {
	...
	if seqLen > 2048 {
		return longAttention(out, q, nil, nil, trunkK, trunkV, suffixK, suffixV, active, batch, 0, 0, 0, nHeads, nKVHeads, headDim, trunkLen, suffixStride, seqStart, seqLen, 1, seqLen, scale)
	}
	if suffixK == nil {
		suffixK = &Buffer{}
	}
