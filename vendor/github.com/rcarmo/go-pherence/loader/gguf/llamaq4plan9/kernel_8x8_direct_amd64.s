...
TEXT ·_go_llama_q4_0_q8_0_8x8_direct(SB), $592-40
    ...
    LONG $0xc9148d4b             // lea    rdx, [r9 + 8*r9]
...
LBB0_3:
    QUAD $0x0001a024947f7ec5; BYTE $0x00 // vmovdqu    yword [rsp + 416], ymm10
    QUAD $0x0001c0248c117cc5; BYTE $0x00 // vmovups    yword [rsp + 448], ymm9
    QUAD $0x0001e024847f7ec5; BYTE $0x00 // vmovdqu    yword [rsp + 480], ymm8
    QUAD $0x00020024bc11fcc5; BYTE $0x00 // vmovups    yword [rsp + 512], ymm7
    QUAD $0x00022024b411fcc5; BYTE $0x00 // vmovups    yword [rsp + 544], ymm6
    QUAD $0x0000c024a411fcc5; BYTE $0x00 // vmovups    yword [rsp + 192], ymm4
    QUAD $0x0000e0248411fcc5; BYTE $0x00 // vmovups    yword [rsp + 224], ymm0
    QUAD $0x000120248c6f7ec5; BYTE $0x00 // vmovdqu    ymm9, yword [rsp + 288]
    LONG $0xef35a1c4; WORD $0x0f44; BYTE $0x10 // vpxor    ymm0, ymm9, yword [rdi + r9 + 16]
    LONG $0xef35a1c4; WORD $0x0f4c; BYTE $0x30 // vpxor    ymm1, ymm9, yword [rdi + r9 + 48]
    ...
    LONG $0x447ffec5; WORD $0x4024 // vmovdqu    yword [rsp + 64], ymm0
    QUAD $0x00010024b46ffec5; BYTE $0x00 // vmovdqu    ymm6, yword [rsp + 256]
    LONG $0xcedbedc5             // vpand    ymm1, ymm2, ymm6
    QUAD $0x000080248c7ffec5; BYTE $0x00 // vmovdqu    yword [rsp + 128], ymm1
    ...
    LONG $0x00fde3c4; WORD $0x44c0 // vpermq    ymm0, ymm0, 68
    QUAD $0x000080248c70fdc5; WORD $0xdd00 // vpshufd    ymm1, yword [rsp + 128], 221
    LONG $0x507562c4; BYTE $0xd0                                 // {vex}    vpdpbusd    ymm10, ymm1, ymm0
    ...
    QUAD $0x00018024a47ffec5; BYTE $0x00 // vmovdqu    yword [rsp + 384], ymm4
    ...
    LONG $0xef35a1c4; WORD $0x0f4c; BYTE $0x50 // vpxor    ymm1, ymm9, yword [rdi + r9 + 80]
    LONG $0x506d62c4; BYTE $0xe8                                 // {vex}    vpdpbusd    ymm13, ymm2, ymm0
    LONG $0xef35a1c4; WORD $0x0f44; BYTE $0x70 // vpxor    ymm0, ymm9, yword [rdi + r9 + 112]
    ...
    QUAD $0x00016024bc7ffec5; BYTE $0x00 // vmovdqu    yword [rsp + 352], ymm7
    ...
    LONG $0x507562c4; BYTE $0xe0                                 // {vex}    vpdpbusd    ymm12, ymm1, ymm0
    LONG $0x506d62c4; BYTE $0xd8                                 // {vex}    vpdpbusd    ymm11, ymm2, ymm0
    QUAD $0x00008024a47ffec5; BYTE $0x00 // vmovdqu    yword [rsp + 128], ymm4
    LONG $0xc470f9c5; BYTE $0xf5 // vpshufd    xmm0, xmm4, 245
    LONG $0x00fde3c4; WORD $0x44c0 // vpermq    ymm0, ymm0, 68
    LONG $0x507562c4; BYTE $0xf0                                 // {vex}    vpdpbusd    ymm14, ymm1, ymm0
    LONG $0x506d62c4; BYTE $0xf8                                 // {vex}    vpdpbusd    ymm15, ymm2, ymm0
    ...
    LONG $0x4c6ffec5; WORD $0x4024 // vmovdqu    ymm1, yword [rsp + 64]
    ...
    LONG $0x647ffec5; WORD $0x4024 // vmovdqu    yword [rsp + 64], ymm4
    LONG $0xc470f9c5; BYTE $0xf5 // vpshufd    xmm0, xmm4, 245
    LONG $0x00fde3c4; WORD $0x44c0 // vpermq    ymm0, ymm0, 68
    ...
    LONG $0x507562c4; BYTE $0xe0                                 // {vex}    vpdpbusd    ymm12, ymm1, ymm0
    LONG $0x506d62c4; BYTE $0xd8                                 // {vex}    vpdpbusd    ymm11, ymm2, ymm0
    LONG $0x4c7f7ec5; WORD $0x6024 // vmovdqu    yword [rsp + 96], ymm9
    ...
    QUAD $0x00a02484506de2c4; WORD $0x0000                       // {vex}    vpdpbusd    ymm0, ymm2, YMMWORD PTR [rsp + 160]
    QUAD $0x01602484506de2c4; WORD $0x0000                       // {vex}    vpdpbusd    ymm0, ymm2, YMMWORD PTR [rsp + 352]
    ...
    QUAD $0x00020024bc10fcc5; BYTE $0x00 // vmovups    ymm7, yword [rsp + 512]
    ...
    QUAD $0x0001c0248c107cc5; BYTE $0x00 // vmovups    ymm9, yword [rsp + 448]
    ...
    LONG $0xb86562c4; BYTE $0xcd // vfmadd231ps    ymm9, ymm3, ymm5
    LONG $0x6d2dc1c4; BYTE $0xd8 // vpunpckhqdq    ymm3, ymm10, ymm8
    QUAD $0x0001a02494107cc5; BYTE $0x00 // vmovups    ymm10, yword [rsp + 416]
    ...
    QUAD $0x0180249c505de2c4; WORD $0x0000                       // {vex}    vpdpbusd    ymm3, ymm4, YMMWORD PTR [rsp + 384]
    QUAD $0x0080249c505de2c4; WORD $0x0000                       // {vex}    vpdpbusd    ymm3, ymm4, YMMWORD PTR [rsp + 128]
    LONG $0x505de2c4; WORD $0x245c; BYTE $0x60                   // {vex}    vpdpbusd    ymm3, ymm4, YMMWORD PTR [rsp + 96]
    ...
    QUAD $0x0001e02484107cc5; BYTE $0x00 // vmovups    ymm8, yword [rsp + 480]
    ...
    LONG $0xb87d62c4; BYTE $0xc2 // vfmadd231ps    ymm8, ymm0, ymm2
    ...
    QUAD $0x0000a0249c6f7ec5; BYTE $0x00 // vmovdqu    ymm11, yword [rsp + 160]
    LONG $0x6c25c1c4; BYTE $0xdd // vpunpcklqdq    ymm3, ymm11, ymm13
    ...
    LONG $0x187de2c4; BYTE $0xe4 // vbroadcastss    ymm4, xmm4
    LONG $0xe159dcc5             // vmulps    ymm4, ymm4, ymm1
    QUAD $0x0000c024ac10fcc5; BYTE $0x00 // vmovups    ymm5, yword [rsp + 192]
    LONG $0xb865e2c4; BYTE $0xec // vfmadd231ps    ymm5, ymm3, ymm4
    QUAD $0x0000c024ac11fcc5; BYTE $0x00 // vmovups    yword [rsp + 192], ymm5
    QUAD $0x0000c024a410fcc5; BYTE $0x00 // vmovups    ymm4, yword [rsp + 192]
    LONG $0x6d25c1c4; BYTE $0xdd // vpunpckhqdq    ymm3, ymm11, ymm13
    ...
    QUAD $0x0000e0249410fcc5; BYTE $0x00 // vmovups    ymm2, yword [rsp + 224]
    LONG $0xb875e2c4; BYTE $0xd0 // vfmadd231ps    ymm2, ymm1, ymm0
    QUAD $0x0000e0249411fcc5; BYTE $0x00 // vmovups    yword [rsp + 224], ymm2
    QUAD $0x0000e0248410fcc5; BYTE $0x00 // vmovups    ymm0, yword [rsp + 224]
...
LBB0_1:
    ...
    LONG $0x573041c4; BYTE $0xc9 // vxorps    xmm9, xmm9, xmm9
LBB0_4:
    LONG $0x09117cc5             // vmovups    yword [rcx], ymm9
    WORD $0x6349; BYTE $0xc0     // movsxd    rax, r8d
    LONG $0x4c10fcc5; WORD $0x2024 // vmovups    ymm1, yword [rsp + 32]
    LONG $0x0c11fcc5; BYTE $0x81 // vmovups    yword [rcx + 4*rax], ymm1
    WORD $0x148d; BYTE $0x00     // lea    edx, [rax + rax]
    WORD $0x6348; BYTE $0xd2     // movsxd    rdx, edx
    LONG $0x147f7ec5; BYTE $0x91 // vmovdqu    yword [rcx + 4*rdx], ymm10
    WORD $0x348d; BYTE $0x40     // lea    esi, [rax + 2*rax]
    WORD $0x6348; BYTE $0xf6     // movsxd    rsi, esi
    LONG $0x047f7ec5; BYTE $0xb1 // vmovdqu    yword [rcx + 4*rsi], ymm8
    LONG $0x0085348d; WORD $0x0000; BYTE $0x00 // lea    esi, [4*rax]
    WORD $0x6348; BYTE $0xf6     // movsxd    rsi, esi
    LONG $0x3c11fcc5; BYTE $0xb1 // vmovups    yword [rcx + 4*rsi], ymm7
    WORD $0x348d; BYTE $0x80     // lea    esi, [rax + 4*rax]
    WORD $0x6348; BYTE $0xf6     // movsxd    rsi, esi
    LONG $0x3411fcc5; BYTE $0xb1 // vmovups    yword [rcx + 4*rsi], ymm6
    WORD $0x148d; BYTE $0x52     // lea    edx, [rdx + 2*rdx]
    WORD $0x6348; BYTE $0xd2     // movsxd    rdx, edx
    LONG $0x2411fcc5; BYTE $0x91 // vmovups    yword [rcx + 4*rdx], ymm4
    LONG $0x00c5148d; WORD $0x0000; BYTE $0x00 // lea    edx, [8*rax]
    WORD $0xc229                 // sub    edx, eax
    WORD $0x6348; BYTE $0xc2     // movsxd    rax, edx
    LONG $0x0411fcc5; BYTE $0x81 // vmovups    yword [rcx + 4*rax], ymm0
