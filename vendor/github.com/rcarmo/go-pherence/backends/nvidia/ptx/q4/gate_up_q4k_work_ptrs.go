...
const GateUpQ4KByWorkPtrsPTX = `.version 7.0
.target sm_80
.address_size 64

.visible .entry gate_up_q4_k_by_work_ptrs(
    .param .u64 param_x,
    .param .u64 param_work_experts,
    .param .u64 param_q_ptrs,
    .param .u64 param_scale_ptrs,
    .param .u64 param_min_ptrs,
    .param .u64 param_gate_out,
    .param .u64 param_up_out,
    ...
    ld.param.u64 %rd5, [param_gate_out];
    ld.param.u64 %rd37, [param_up_out];
